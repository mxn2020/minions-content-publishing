...
/**
 * @minions-content-publishing/cli — CLI for Minions Content-publishing
 *
...
import { customTypes } from '@minions-content-publishing/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Content-publishing'));
        console.log(chalk.dim('Publish queue, delivery receipts, and mode configuration'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-content-publishing/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-content-publishing/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-content-publishing')}`);
